...
class ObjFunction(object):
    ...
    def __call__(self, X):
        ...
        if _X.ndim > 2:
            raise Exception("ObjFunc Solution Error: Only support 2d np.ndarray input, but have input shape {}.".format(_X.shape))
...
class Evaluator(object):
    ...
    def __init__(self, obj_func, max_eval=-1, max_batch=-1, traj_mod=0):
        ...
        self.num_eval = 0
        self.num_batch = 0
        self.unimprove_eval = 0
        self.unimprove_batch = 0
    ...
    def eval(self, X):
        ...
        if num == 1:
            ...
            if self.cur_y is None or y < self.cur_y:
                ...
                self.unimprove_eval += 1
                self.unimprove_batch += 1
